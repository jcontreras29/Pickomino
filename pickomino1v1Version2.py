...
def pickomino(beast0319, highestDominoe, dominoes):
    beastHigh = 0
    if (len(beast0319) > 0):
        for i in beast0319:
            if (int(i) > beastHigh):
    ...
    while keepRunning:
        ...
        if (len(keepers) == 8 and ('Worm' in keepers)):
            if (total not in dominoes):
                ...
                dominoes.pop()
                if (len(beast0319) != 0):
                    beast0319.remove(beastHigh)
                    dominoes.append(beastHigh)
                    dominoes.sort()
                else:
                    dominoes.sort()
            else:
...
def yesOrNoAlg(kept, total, beast0319, opposition, highestDominoe, dominoes):
    ...
    if (worms == 0):
        ...
        return True
    elif (len(opposition) > 0):
        if (total == opposition[-1]):
            opposition.pop()
            return False
    if (total < 21):
        return True
...
while True:
    ...
    if (str(player1) == 'quit'):
        ...
        if (int(player1) < 21 or int(player1) > highestDominoe):
            dominoes.pop()
            if (len(opposition) != 0):
                opposition.remove(oppLargest)
                dominoes.append(oppLargest)
                dominoes.sort()
            else:
                dominoes.sort()
        print("Your new dominoes:",opposition)
        pickomino(beast0319, highestDominoe, dominoes)
    _round+=1
    if (len(dominoes) == 0):
        print("Game over!")
